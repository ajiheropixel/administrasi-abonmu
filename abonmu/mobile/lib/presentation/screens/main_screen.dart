...
class _MainScreenState extends State<MainScreen> {
  ...
  // Semua nav items — admin & owner sama-sama bisa akses semua halaman
  // Perbedaan hanya di dalam masing-masing screen (tombol tambah/edit/hapus disembunyikan untuk owner)
  static const List<_NavItem> _navItems = [
    _NavItem(icon: Icons.home_outlined,         activeIcon: Icons.home,          label: 'Dashboard',   adminOnly: false),
    _NavItem(icon: Icons.factory_outlined,       activeIcon: Icons.factory,       label: 'Produksi',    adminOnly: false),
    _NavItem(icon: Icons.inventory_2_outlined,   activeIcon: Icons.inventory_2,   label: 'Produk',      adminOnly: false),
    _NavItem(icon: Icons.shopping_cart_outlined, activeIcon: Icons.shopping_cart, label: 'Penjualan',   adminOnly: false),
    _NavItem(icon: Icons.receipt_long_outlined,  activeIcon: Icons.receipt_long,  label: 'Pengeluaran', adminOnly: false),
    _NavItem(icon: Icons.people_outline,         activeIcon: Icons.people,        label: 'Pelanggan',   adminOnly: false),
    _NavItem(icon: Icons.badge_outlined,         activeIcon: Icons.badge,         label: 'Karyawan',    adminOnly: false),
    _NavItem(icon: Icons.bar_chart_outlined,     activeIcon: Icons.bar_chart,     label: 'Laporan',     adminOnly: false),
  ];
                ...
                child: GestureDetector(
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.menu,
                          size: 22,
                          color: _currentIndex >= 5 ? Colors.white : const Color(0xFF94A3B8)),
                      const SizedBox(height: 2),
                      Text('Menu',
                          style: TextStyle(
                            fontSize: 10,
          ...
          Expanded(
            child: ListView(
              ...
              children: navItems.asMap().entries.map((e) {
                final i = e.key;
                final item = e.value;
                // Sembunyikan menu adminOnly jika bukan admin
                if (item.adminOnly && !isAdmin) return const SizedBox.shrink();
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        isAdmin ? Icons.admin_panel_settings : Icons.visibility,
                        size: 12,
                        color: isAdmin ? Colors.blue[300] : Colors.green[300],
                      ),
                      const SizedBox(width: 4),
                      Text(
                        isAdmin ? 'Admin — Akses Penuh' : 'Owner — Hanya Lihat',
                        style: TextStyle(
                          fontSize: 10,
                          color: isAdmin ? Colors.blue[300] : Colors.green[300],
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Menu items 5–7 (filter adminOnly)
